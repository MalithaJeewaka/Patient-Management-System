"use client"; // client side bcz has interractions with clients
      ...
      >
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          ...
          <CustomFormField
            ...
            // we use skeleton bcz we can use renderSkeleton method and get the access to the field and render different things
            control={form.control}
            name="gender"
            label="Gender"
            placeholder="111 222 333 444"
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField
            ...
            placeholder="Mother had gastritis, Father had cough"
          />
